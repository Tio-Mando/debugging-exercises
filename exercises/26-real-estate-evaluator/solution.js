...
class MarketAnalyzer {
  ...
  getMedianPrice() {
    if (this.listings.length === 0) return 0;
    // CORREGIDO: ordena los precios antes de encontrar la mediana
    // Sin ordenar, el elemento del centro del arreglo original es arbitrario y no representa la mediana real
