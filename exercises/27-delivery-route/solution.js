...
class RouteCalculator {
  ...
  calculateRouteDistance(depot, stops) {
    ...
    // CORREGIDO: suma el tramo de regreso desde la última parada al depósito
    // Sin este tramo, la ruta calculada es solo de ida y el costo real de combustible
    // y tiempo es significativamente mayor al estimado
