...
class Analytics {
  ...
  getEngagementRate() {
    ...
    // CORREGIDO: divide entre los seguidores del autor, no entre el número de publicaciones
    // El engagement rate mide qué porcentaje de la audiencia interactúa con el contenido
    // Dividir entre posts.length daría un número sin sentido relativo a la audiencia
