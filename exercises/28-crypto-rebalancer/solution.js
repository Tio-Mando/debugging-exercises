...
class Portfolio {
  ...
  getRebalancePlan(prices) {
    ...
    return this.assets.map((asset) => {
      ...
      // CORREGIDO: usa el porcentaje objetivo de cada activo para calcular su valor deseado
      // Con el bug, todos los activos reciben la misma asignación (totalValue / n),
      // ignorando completamente las proporciones definidas en targetPercentage
