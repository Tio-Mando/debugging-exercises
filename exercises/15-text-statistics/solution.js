...
function countWords(text) {
  ...
  // CORREGIDO: Usa una expresión regular para dividir por uno o más espacios,
  // evitando contar strings vacíos generados por espacios múltiples
...
function getAverageWordLength(text) {
  ...
  // CORREGIDO: Divide entre words.length (número de palabras),
  // no entre countSentences(text) (número de oraciones)
...
function getMostFrequentWord(text) {
  ...
  // CORREGIDO: Normaliza a minúsculas para comparar sin distinción de mayúsculas
