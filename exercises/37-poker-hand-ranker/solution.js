...
function rankHand(hand) {
  ...
  // CORREGIDO: full house requiere un trío Y un par, por lo que se debe usar
  // && (y lógico). Con || (o lógico) un trío solo también satisface la
  // condición porque first === 3 es verdadero, clasificando tríos como full house.
