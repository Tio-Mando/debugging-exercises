...
// CORREGIDO: aplica cada descuento de forma secuencial sobre el precio resultante.
// El bug sumaba todas las tasas y aplicaba una sola vez al precio original,
// sobreestimando el ahorro (e.g., 10% + 20% = 30% en lugar de 10% luego 20% = 28%).
...
if (require.main === module) {
  console.log('Stack [10%, 20%] on $100:', stackDiscounts(100, [0.1, 0.2])); // 72
  console.log('Best offer on $100:', getBestOffer(100, [[0.1, 0.1], [0.2], [0.15, 0.05]])); // 80
  const items = [{ price: 50, quantity: 2 }, { price: 10, quantity: 5 }];
  console.log('Order total:', calculateOrderTotal(items)); // 150
  console.log('Breakdown:', getDiscountBreakdown(100, [0.1, 0.2]));
}
