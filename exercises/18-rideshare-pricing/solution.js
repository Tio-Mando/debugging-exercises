...
class PriceCalculator {
  ...
  calculateFare(ride) {
    ...
    // CORREGIDO: el multiplicador de surge debe aplicarse al total del viaje, no solo a la tarifa base
    // Si surge=2 y el viaje cuesta $18.25 sin surge, el total debe ser $36.50, no $23.75
