...
function checkLength(
  ...
  // CORREGIDO: Usa >= y <= para incluir los valores límite exactos (8 y 20 caracteres son válidos)
...
function checkComplexity(password) {
  return {
    // CORREGIDO: Usa /[A-Z]/ para detectar mayúsculas (no /[a-z]/ que detecta minúsculas)
...
function calculateStrength(password) {
  // CORREGIDO: Inicia el score en 0, no en 1, para que el rango sea exactamente 0-5
  let score = 0;
