...
class RecommendationEngine {
  ...
  calculateScore(book) {
    ...
    // CORREGIDO: divide entre los temas preferidos del usuario, no entre los temas del libro
    // El score mide cuántos de los intereses del usuario cubre el libro:
    //   - Un libro que cubre los 3 intereses del usuario → score 1.0
    //   - Un libro que cubre 1 de 3 intereses → score 0.33
    // Con el bug, un libro con pocos temas pero que coincidan todos tendría score 1.0,
    // aunque solo cubra 1 de los 3 intereses del usuario
