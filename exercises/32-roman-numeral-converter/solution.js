...
// CORREGIDO: la tabla debe estar ordenada de MAYOR a MENOR.
// Con orden ascendente el algoritmo greedy nunca puede aplicar
// los pares de sustracción (CM, CD, XC, etc.) porque siempre
// encuentra primero el valor más pequeño.
const ROMAN_TABLE = [
  [1000, 'M'],
  [900, 'CM'],
  [500, 'D'],
